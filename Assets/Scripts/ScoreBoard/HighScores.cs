...
{
    const string privateCode = "U27GJ7vNeUqXv6bfNXHhWg7LsEpbhWKEOUbOGNJHo1oA";  //Key to Upload New Info
    const string publicCode = "66685b398f40bb12c86a81c1";   //Key to download
    ...
    void OrganizeInfo(string rawData) //Divides Scoreboard info by new lines
    {
        ...
        for (int i = 0; i < entries.Length; i ++) //For each entry in the string array
        {
            ...
            int score = 100000 - int.Parse(entryInfo[1]);
